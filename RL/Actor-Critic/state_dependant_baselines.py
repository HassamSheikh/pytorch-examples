""" Implementation Batch Actor-Critic Method as taught in CS 294. State dependant Baseline where Value function is fitted using Monte Carlo Policy Evalution
"""
